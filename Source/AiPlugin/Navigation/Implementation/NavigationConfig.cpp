...
void plAiNavigationConfig::Save(plStreamWriter& inout_stream) const
{
  ...
  // version 3: tactical layer settings
  inout_stream << m_TacticalConfig.m_sCoverNavmesh;
  inout_stream << m_TacticalConfig.m_fCoverSpacing;
  inout_stream << m_TacticalConfig.m_fCoverProbeDistance;
  inout_stream << m_TacticalConfig.m_fCoverCrouchHeight;
  inout_stream << m_TacticalConfig.m_fCoverStandHeight;
  inout_stream << m_TacticalConfig.m_uiMaxCoverPointsPerSector;

  // version 4: squad settings
  inout_stream << m_SquadConfig.m_uiAttackTokens;
  inout_stream << m_SquadConfig.m_fShareConfidence;
  inout_stream << m_SquadConfig.m_fShareStrength;
  inout_stream << m_SquadConfig.m_fShareInterval;
}
...
void plAiNavigationConfig::Load(plStreamReader& inout_stream)
{
  ...
  PL_ASSERT_DEV(uiVersion <= 4, "Invalid version {0} for plAiNavigationConfig file", uiVersion);
