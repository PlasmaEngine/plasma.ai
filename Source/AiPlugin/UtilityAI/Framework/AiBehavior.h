...
/// \brief DEPRECATED: base class of the legacy C++-only utility AI framework.
///
/// New code should author behaviors as 'AI Behavior' assets (consideration-based scoring via
/// plAiBehaviorResource) executed through plAiBehaviorLogic. See plAiBrainWorldModule.
