...
class PL_EDITORPLUGINAI_DLL plAiEditorAction : public plButtonAction
{
  PL_ADD_DYNAMIC_REFLECTION(plAiEditorAction, plButtonAction);
...
public:
  ...
  plAiEditorAction(const plActionContext& context, const char* szName, ActionType type);
  ~plAiEditorAction();
