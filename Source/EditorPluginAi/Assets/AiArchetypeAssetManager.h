...
class plAiArchetypeAssetDocumentManager : public plAssetDocumentManager
{
  PL_ADD_DYNAMIC_REFLECTION(plAiArchetypeAssetDocumentManager, plAssetDocumentManager);

public:
  plAiArchetypeAssetDocumentManager();
  ~plAiArchetypeAssetDocumentManager();
