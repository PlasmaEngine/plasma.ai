...
class plAiBehaviorAssetDocumentManager : public plAssetDocumentManager
{
  PL_ADD_DYNAMIC_REFLECTION(plAiBehaviorAssetDocumentManager, plAssetDocumentManager);

public:
  plAiBehaviorAssetDocumentManager();
  ~plAiBehaviorAssetDocumentManager();
