...
class plAiEqsQueryAssetDocumentManager : public plAssetDocumentManager
{
  PL_ADD_DYNAMIC_REFLECTION(plAiEqsQueryAssetDocumentManager, plAssetDocumentManager);

public:
  plAiEqsQueryAssetDocumentManager();
  ~plAiEqsQueryAssetDocumentManager();
